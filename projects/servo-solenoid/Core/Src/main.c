...
int main(void)
{
 ...
 // __HAL_TIM_SET_COUNTER(&htim6, 0);
  ...
  /*double angle = 90;
  int DutyCycleInput = 0;
  double absoluteAngle = angle + 90.0;
  DutyCycleInput = (int)(((2500.0-500.0)/(180.0-0.0))*absoluteAngle + 500.0); //y = mx + b (Linear)
